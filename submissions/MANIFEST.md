...
|---|---|---|---|---|---|---|
| 56276676 | 2026-09-16 10:44 | `56276676__michael_108056090_s0.py` | `58f0c9bd02673897` | Michael Shihong Zhang 单表 + 修复层（与赢家相似度 81.8%） | 977.2 | ✗ 远低于赢家 |
| 56276674 | 2026-09-16 10:43 | `56276674__tllswelp_108089814_s0.py` | `e82c17221bdc9da4` | tllswelp 单表 + 修复层（83.9%） | 894.4 | ✗ 远低于赢家 |
| 56276673 | 2026-09-16 10:43 | `56276673__zhongyi_108062853_s1.py` | `722d95925f50e072` | Zhongyi Dai 单表 + 修复层（84.0%） | 600.0 | ✗ 始终是起始分 |
...
| 56275283 | 2026-09-16 09:28 | `56275283__adarsh_route_library.py` | `8AE5C0922B6133C2` | 11 张动作表按商店前缀自动选表 + 修复层 | 1321.1（仍在爬） | ✗ **不如单表版** |
...
9. **「换一张别人的表」这条轴已被证伪（2026-09-16）。** 一次性并行试了三张与赢家风格**最接近**
   的表（82%–84%），结果全部远低于赢家 —— 见上表 56276673/4/6。
   **结论：换表不是杠杆。** 赢家不是「某种风格」的产物，而是那一张具体的表。
   至此累计 **15 次尝试，只有 1 次成功**。
